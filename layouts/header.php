...
<div class="header">
            ...
            <div class="col l-7 header-nav-box">
                <div class="header-nav">
                    <ul class="items-big">
                        ...
                        <li class="nav-item tag-li ">
                            <a href="<?=$baseUrl?>sanpham" class="tag-a">
                                <span class="danhmuc-sanpham">Sản phẩm<i class="fa-solid fa-caret-down"></i></span>
                            </a>
                            <ul class="item-small">
                                <li class="tag-li"><a href="<?=$baseUrl?>raucu" class="tag-a">Rau củ</a></li>
                                <li class="tag-li"><a href="<?=$baseUrl?>hoaqua" class="tag-a">Hoa quả</a></li>
                                <li class="tag-li"><a href="<?=$baseUrl?>haisan" class="tag-a">Hải sản</a></li>
                                <li class="tag-li"><a href="<?=$baseUrl?>cacloaihat" class="tag-a">Các loại hạt</a></li>
                                <li class="tag-li"><a href="<?=$baseUrl?>thucphamtuoisong" class="tag-a">Thực phẩm tươi sống</a></li>
                            </ul>
                        </li>
                        <li class="nav-item tag-li ">
                        ...
                        <li class="nav-item tag-li ">
                            <a href="<?=$baseUrl?>lienhe" class="tag-a">
                ...
                <div class="cart-group">
                    <div class="icon-search cart-group-item">
                        ...
                        <div class="search-mini">
                            <input type="text" placeholder="Tìm kiếm..." class="button_gradient input-header">
    ...
    <div class="list-icon">
        ...
        <a href="<?=$baseUrl?>https://www.zalo.me/0334277969" class="tag-a">
            <div class="icon-item-box">
                <div class="icon-des-item icon-des-zalo">
                    <span>Chat Zalo ngay cho chúng tôi</span>
                </div>
                <div class="icon-item icon-zalo">
                    <svg width="45" height="45" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="<?=$baseUrl?>https://www.facebook.com/Th%E1%BB%B1c-ph%E1%BA%A9m-xanh-Oars-Organic-112298208114292" class="tag-a">
            <div class="icon-item-box">
